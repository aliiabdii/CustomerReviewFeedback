 ...
 */
package org.customcommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import org.customcommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "customcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "customcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "customcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "customcommercewebservices.v2.description";
	private static final String TITLE = "customcommercewebservices.v2.title";
	private static final String VERSION = "customcommercewebservices.v2.version";
