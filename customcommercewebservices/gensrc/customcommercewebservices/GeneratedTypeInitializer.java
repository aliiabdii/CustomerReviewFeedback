...
package customcommercewebservices;
...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"CronJob",
			org.customcommercewebservices.jalo.expressupdate.cron.ProductExpressUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			org.customcommercewebservices.jalo.expressupdate.cron.OrderStatusUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			org.customcommercewebservices.jalo.OldCartRemovalCronJob.class,
			null,
			false,
			null,
			false
