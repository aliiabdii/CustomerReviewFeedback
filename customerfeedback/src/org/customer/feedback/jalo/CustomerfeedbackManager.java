...
/**
 * This is the extension manager of the Customerfeedback extension.
 */
public class CustomerfeedbackManager extends GeneratedCustomerfeedbackManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CustomerfeedbackManager.class);
	 ...
	 */
	public static CustomerfeedbackManager getInstance()
	{
		return (CustomerfeedbackManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CustomerfeedbackConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomerfeedbackManager() // NOPMD 
	{
		LOG.debug("constructor of CustomerfeedbackManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CustomerfeedbackManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CustomerfeedbackManager called, current tenant: {}", getTenant().getTenantID());
	}
